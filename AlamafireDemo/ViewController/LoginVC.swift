...
class LoginVC: UIViewController,UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        refDatabase = Database.database().reference().child("User").child("-LSrz802sxZZDs4kPKwe")
    }
    ...
    @IBAction func gotoHomePage()
    {
        ...
        {
            UIAlertController.showAlertWithTextField(vc: self, titleStr: "Reason For Close", messageStr: "", ReasenForClose: "Close")
        }else{
            SVProgressHUD.show()
